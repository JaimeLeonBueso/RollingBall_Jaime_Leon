...
public class EfectoAspersor : MonoBehaviour
{
    ...
    void Update()
    {
            if (contador1 > 0)
            {
                transform.Rotate(direccion1 * velocidadDireccion1 * Time.deltaTime, Space.Self);
            ...
            {
                transform.Rotate(direccion2 * velocidadDireccion2 * Time.deltaTime, Space.Self);
